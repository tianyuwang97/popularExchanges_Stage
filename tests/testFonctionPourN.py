...
def testCondition(res):
    ...
    for i in range(len(comb)):
        ...
        for j in range(len(res)):
            stock=False
            # print(j+1,"eme allocation")
            test = False
            cpt = 0
            for m in range(len(res[j])):

                if ((pivot[0] == res[j][m][0] and pivot[1] == res[j][m][1] and pivot[2] == res[j][m][2])): #123
                    #                     print("pivot[0]:",pivot[0])
                    #                     print("res[j][m][0]:",res[j][m][0])
                    #                     print("pivot[1]:",pivot[1])
                    #                     print("res[j][m][1]:",res[j][m][1])
                    #                     print("pivot[2]:",pivot[2])
                    #                     print("res[j][m][2]:",res[j][m][2])
                    cpt += 1
                elif ((pivot[0] == res[j][m][0] and pivot[1] == res[j][m][1] and pivot[2] == res[j][m][3])): #124
                    #                     print("pivot[0]:",pivot[0])
                    #                     print("res[j][m][0]:",res[j][m][0])
                    #                     print("pivot[1]:",pivot[1])
                    #                     print("res[j][m][1]:",res[j][m][1])
                    #                     print("pivot[2]:",pivot[2])
                    #                     print("res[j][m][3]:",res[j][m][3])
                    cpt += 1
                elif ((pivot[0] == res[j][m][1] and pivot[1] == res[j][m][2] and pivot[2] == res[j][m][3])): #234
                    #                     print("pivot[0]:",pivot[0])
                    #                     print("res[j][m][1]:",res[j][m][1])
                    #                     print("pivot[1]:",pivot[1])
                    #                     print("res[j][m][2]:",res[j][m][2])
                    ...
                    #                     print("res[j][m][3]:",res[j][m][3])
                    cpt += 1
                elif ((pivot[0] == res[j][m][0] and pivot[1] == res[j][m][2] and pivot[2] == res[j][m][3])): #134
                    #                     print("pivot[0]:",pivot[0])
                    #                     print("res[j][m][0]:",res[j][m][0])
                    #                     print("pivot[1]:",pivot[1])
                    #                     print("res[j][m][2]:",res[j][m][2])
                    ...
                    cpt += 1
                elif ((pivot[0] == res[j][m][0] and pivot[1] == res[j][m][3] and pivot[2] == res[j][m][4])):
                    cpt += 1
                elif ((pivot[0] == res[j][m][0] and pivot[1] == res[j][m][2] and pivot[2] == res[j][m][4])):
                    cpt += 1
                elif ((pivot[0] == res[j][m][0] and pivot[1] == res[j][m][1] and pivot[2] == res[j][m][4])):
                    cpt += 1
                elif ((pivot[0] == res[j][m][1] and pivot[1] == res[j][m][2] and pivot[2] == res[j][m][4])):
                    cpt += 1
                elif ((pivot[0] == res[j][m][1] and pivot[1] == res[j][m][3] and pivot[2] == res[j][m][4])):
                    cpt += 1
                elif ((pivot[0] == res[j][m][2] and pivot[1] == res[j][m][3] and pivot[2] == res[j][m][4])):
                    cpt += 1
    ...
    ok2 = []
    # il y a 4 elements sont pareiles pour la deuxieme ligne
    val = 0
    listrecord2 = []
