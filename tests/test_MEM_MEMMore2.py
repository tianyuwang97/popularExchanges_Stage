...
import memMatching,memMatchingMore2,memMatchingA4, memMatchingA3_A4,randomPathPop, utility, allocTools
import os
...
def testMEMMEMA(nbTests, f, nb_player):
    ...
    while nbDone < nbTests :
        ...
        b1,b2=  memMatchingMore2.mem_matching(nb_resources, preferences, f, True)
