...
import memMatching,memMatchingA3_A4, randomPathPop, utility, allocTools,memA2
import os
...
def testMEMMEMA(nbTests, f, nb_player):
    ...
    while nbDone < nbTests :
        ...
        ScoreBordaMEMA,RangMaxMinMEMA =memMatchingA3_A4.mem_matching(nb_resources,preferences,f,True)
        #ScoreBordaMEMA2, RangMaxMinMEMA2 = memA2.mem_matching(nb_resources, preferences, f, True)
...
def main():
    ...
    a,b,c,d,e,f = testMEMMEMA(nbTests, utility.additive, 6)
    print(a,b,c,d)
