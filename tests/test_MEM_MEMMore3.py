...
import memMatching,memMatchingMore3,memMatchingA4, memMatchingA3_A4,randomPathPop, utility, allocTools
import os
...
def testMEMMEMA(nbTests, f, nb_player):
    ...
    while nbDone < nbTests :
        ...
        b1,b2=  memMatchingMore3.mem_matching(nb_resources, preferences, f, True)
...
def main():
    ...
    pyplot.bar(r2, y2, width=barWidth, color=['pink' for i in y2], label='MEMMinFirstHouseArc>MEM')
