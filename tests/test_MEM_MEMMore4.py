...
import memMatching,memMatchingMore4,memMatchingA4, memMatchingA3_A4,randomPathPop, utility, allocTools
import os
...
def testMEMMEMA(nbTests, f, nb_player):
    ...
    while nbDone < nbTests :
        ...
        b1,b2=  memMatchingMore4.mem_matching(nb_resources, preferences, f, True)
