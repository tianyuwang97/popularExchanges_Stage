...
import memMatchinPlus, memMatchingRandom,randomPathPop, utility, allocTools,memA2
import os
...
def testMEMMEMA(nbTests, f, nb_player):
    ...
    while nbDone < nbTests :
        ...
        ScoreBordaMEM,RangMaxMinMEM = memMatchingRandom.mem_matching(nb_resources, preferences, f, True)
        ScoreBordaMEMA,RangMaxMinMEMA =memMatchinPlus.mem_matching(nb_resources,preferences,f,True)
