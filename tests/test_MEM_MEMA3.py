...
import memMatching,memMatchingA3, randomPathPop, utility, allocTools,memA2
import os
...
def testMEMMEMA(nbTests, f, nb_player):
    ...
    while nbDone < nbTests :
        ...
        ScoreBordaMEMA,RangMaxMinMEMA =memMatchingA3.mem_matching(nb_resources,preferences,f,True)
